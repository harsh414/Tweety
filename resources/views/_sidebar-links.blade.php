<ul id="addShadow">
    ...
    <li class="flex mb-4 p-2 rounded-full" id="addShadow">
        ...
        @endif
        <a class="font-bold text-lg ml-3 block" href="{{route('notifications')}}" style="text-decoration: none">
            Notifications
        </a>
    </li>
    <li class="flex mb-4 p-2  rounded-full lg:w-3/4" id="addShadow">
    ...
    <li class="flex mb-4 p-2 rounded-full lg:w-3/4" id="addShadow">
        ...
        <a class="font-bold text-lg ml-3 block" id="more" style="text-decoration: none;cursor: pointer">
            More
        </a>
    </li>
