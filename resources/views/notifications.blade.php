...
@section('content')
    ...
    @foreach(auth()->user()->notifications as $notification)
        ...
        @elseif($notification->data['type']=='New tweet')
            <div id="notificationBg" style="cursor: pointer">
            ...
            <div class="mt-3 ml-4" style="color: darkcyan">
        ...
        @elseif($notification->data['type']=='newFollowing')
            <div id="notificationBg" style="cursor: pointer">
                <a href="{{route('profile',$notification->data['id'])}}" style="text-decoration: none;color: black">
            <div class="flex mt-6">
