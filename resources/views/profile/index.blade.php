...
<div class="flex justify-between">
    ...
    <button type="button" class="hover:bg-blue-100 rounded-lg rounded-lg p-2 font-bold text-blue-400"
    data-toggle="modal" data-target="#exampleModal" style="border:2px solid lightskyblue;outline: none; border-radius: 20px !important;">Edit profile</button>
</div>
